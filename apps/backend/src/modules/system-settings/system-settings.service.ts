...
const DEFAULT_NOTIFICATION_SETTINGS: NotificationSettings = {
  ...
  signalRules: [
    ...
    {
      key: 'hr_attendance_day_end',
      name: 'Gün sonu puantaj hatırlatması',
      area: 'operasyon',
      level: 'uyari',
      trigger: 'Mesai bitiminde (hafta içi 18:00, Cumartesi 13:00)',
      targetRoles: ['Personel', 'İK', 'Finans Süreç Sorumlusu', 'Sistem Yöneticisi'],
      channels: { inApp: true, telegram: false, email: true },
      repeatPolicy: 'Günde bir kez; onaylamayan personele mail, yöneticiye çan',
      active: true,
    },
    {
      key: 'hr_attendance_accountant_auto',
      name: 'Ay sonu mali müşavir puantaj raporu',
      area: 'finans',
      level: 'bilgi',
      trigger: 'Ayın son günü; kaçtıysa ertesi gün',
      targetRoles: ['Finans Süreç Sorumlusu', 'Sistem Yöneticisi'],
      channels: { inApp: true, telegram: false, email: true },
      repeatPolicy: 'Dönemde bir kez; Ayarlar’daki mali müşavir adresine',
      active: true,
    },
    {
      key: 'pending_task',

...
/**
 * Personele giden operasyon uyarıları (Telegram vb.) — yalnız mesai içinde.
 * İş kanunu riski: mesai dışı / tatil / Pazar gönderilmez.
 * Panel girişinden farklı: mesai başlamadan da kapalıdır.
 */
export function isWithinStaffNotifyWindow(now: Date = new Date()): boolean {

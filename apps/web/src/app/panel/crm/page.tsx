  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 px-4 py-10 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <button type="button" onClick={onReset} className="inline-flex h-9 items-center justify-center rounded-md bg-brand-600 px-3 text-xs font-semibold text-white hover:bg-brand-700">
          Filtreleri temizle
        </button>
            ...
            {selected ? (
              <div className="flex h-full flex-col">
                ...
                <div className="border-b border-slate-200 bg-white p-3">
                  {activeActionTab === 'note' && (
                    <section>
                      ...
                      <div className="mt-2.5 flex items-center justify-between gap-3">
                        ...
                        <button type="button" onClick={saveNote} disabled={savingAction === 'note' || !noteForm.summary.trim()} className="inline-flex h-8 items-center justify-center rounded-md bg-brand-600 px-3 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60">
                  ...
                  {activeActionTab === 'followup' && (
                    <section>
                      ...
                      <div className="mt-2.5 flex items-center justify-between gap-3">
                        <span className="text-xs text-slate-500">Sorumlu kişi: Oturumdaki kullanıcı</span>
                        <button type="button" onClick={saveFollowUp} disabled={savingAction === 'follow-up' || !followUpForm.result.trim()} className="inline-flex h-8 items-center justify-center rounded-md bg-brand-600 px-3 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60">
                  ...
                  {activeActionTab === 'status' && (
                    <section>
                      <div className="grid gap-2.5 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
                        ...
                        <button type="button" onClick={saveStatus} disabled={savingAction === 'status'} className="self-end inline-flex h-9 items-center justify-center rounded-md bg-brand-600 px-3 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60">
                    ...
                    <section>
                      ...
                      <div className="mt-2.5 flex items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          className="inline-flex h-8 items-center justify-center rounded-md bg-brand-600 px-3 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60"
                        >
                ...
                <div className="space-y-2.5 p-3">
                  ...
                  <Link href={entityPath(selected)} className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-brand-600 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-700">

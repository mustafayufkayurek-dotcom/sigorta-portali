    ...
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
      ...
      <div className="sticky bottom-0 px-5 py-3 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
        ...
        <button type="button"
          onClick={onSave}
          disabled={saving}
          className={`text-sm px-5 py-2 rounded-lg disabled:opacity-50 transition-colors ${saved ? 'bg-green-600 text-white' : 'bg-brand-600 text-white hover:bg-brand-700'}`}
        >
              ...
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                {showAddField && (
                  <div className="px-5 py-4 bg-blue-50 border-b border-blue-100 flex items-center gap-3">
                    ...
                    />
                    <button type="button" onClick={handleAddField} className="bg-brand-600 text-white text-sm px-3 py-1.5 rounded-lg hover:bg-brand-700">Ekle</button>
            ...
            <>
              ...
              <div className="sticky bottom-0 px-5 py-3 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
                ...
                <button
                  ...
                  disabled={frSaving}
                  className={`text-sm px-5 py-2 rounded-lg disabled:opacity-50 transition-colors ${frSaved ? 'bg-green-600 text-white' : 'bg-brand-600 text-white hover:bg-brand-700'}`}
                >

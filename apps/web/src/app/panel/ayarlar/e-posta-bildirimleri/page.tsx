    ...
    >
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-slate-100 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-slate-50 pt-4">
              <button type="button" onClick={handleSaveMail} disabled={savingMail} className="rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-700 disabled:opacity-50">
      ...
      {activeTab === 'rules' && (
        <div className="rounded-lg border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-slate-50 pt-4">
            <button type="button" onClick={handleSaveNotifications} disabled={savingNotif} className="rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-700 disabled:opacity-50">

    ...
    >
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <button onClick={handleSeed} disabled={seeding} className="px-4 py-2 bg-brand-600 text-white rounded-xl text-sm font-medium hover:bg-brand-700 transition-colors">
            {seeding ? 'Yükleniyor...' : 'Örnek Veri Yükle'}
          </button>
        </div>
      ) : (

      ...
      {showForm && (
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="sm:col-span-2">
              <FinansFieldLabel>İşlem No</FinansFieldLabel>
              <input type="text" readOnly value="Kayıt Sonrası Oluşur" className={`${finansInputClass} bg-slate-50 font-mono text-slate-600`} />
            </div>
            <div>
        ...
        <FinansDataTable>
          <thead className="bg-slate-50 text-xs text-slate-500 border-b border-slate-200">
            <tr>
              ...
              <th className="text-center px-3 py-2.5">İşlem No</th>
              <th className="text-center px-3 py-2.5">Tarih</th>
          ...
          <tbody className="divide-y divide-slate-100">
            {revenues.map((r: any) => (
              <tr key={r.id} className="hover:bg-slate-50/80">
                ...
                <td className="px-3 py-2.5 font-mono text-[11px] text-slate-600 whitespace-nowrap">{financeOperationNo('GLR', r.id, r.createdAt ?? r.entryDate)}</td>

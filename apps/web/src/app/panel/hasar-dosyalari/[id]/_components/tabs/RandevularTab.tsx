                ...
                <div className="flex flex-col gap-1.5 items-end shrink-0">
                  ...
                  {appt.status === 'planned' && (
                    <div className="flex gap-1">
                      <button type="button" onClick={() => handleStatusChange(appt.id, 'confirmed')} className="px-2.5 py-1 text-xs bg-brand-600 text-white rounded-lg hover:bg-brand-700">Onayla</button>

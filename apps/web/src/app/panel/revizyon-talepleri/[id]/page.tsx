            ...
            <div className="space-y-2">
              {detail.status === 'REQUESTED' && (
                <button
                  ...
                  className="w-full bg-brand-600 text-white text-sm px-4 py-2.5 rounded-lg hover:bg-brand-700 disabled:opacity-50 transition-colors font-medium"
                >
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead className="bg-slate-50/70">
                      <tr>
                        <th className="text-center px-5 py-3 text-xs font-semibold text-slate-500 tracking-wide">Kalem</th>
            ...
            <div className="flex-shrink-0 px-4 py-3 border-t border-slate-100">
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="bg-brand-600 text-white p-2.5 rounded-xl hover:bg-brand-700 disabled:opacity-40 transition-colors flex-shrink-0"
                >

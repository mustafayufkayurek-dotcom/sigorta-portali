      ...
      <div className="relative w-full max-w-xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3">
          ...
          <button
            ...
            className="px-5 py-2 rounded-xl text-sm font-semibold bg-brand-600 hover:bg-brand-700 text-white shadow transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {saving ? (
              <>
  ...
  if (accessDenied) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        ...
        <Link href="/panel" className="mt-2 px-4 py-2 bg-brand-600 text-white rounded-lg text-sm font-medium hover:bg-brand-700">Dashboard&apos;a Dön</Link>
      </div>
    );
  }

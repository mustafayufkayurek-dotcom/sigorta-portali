      ...
      <div className="flex flex-col gap-1.5 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-brand-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-brand-700 md:text-sm"
          >

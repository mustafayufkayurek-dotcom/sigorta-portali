                    ...
                    <div className="lg:col-span-8">
                      ...
                      <div className="mt-4 flex flex-wrap gap-1.5">
                        ...
                        <button
                          ...
                          className="t-fast inline-flex items-center gap-1.5 rounded-lg bg-brand-600 px-3 py-2 text-xs font-semibold text-white hover:bg-brand-700"
                        >
              ...
              <div className="space-y-3 xl:col-span-3">
                ...
                <section className="rounded-xl border border-slate-200 bg-white p-3.5 shadow-sm">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      type="button"
                      className="rounded-md bg-brand-600 px-2 py-1 text-[10px] font-semibold text-white hover:bg-brand-700"
                    >
                      + Yeni Not
                    </button>
                  </div>

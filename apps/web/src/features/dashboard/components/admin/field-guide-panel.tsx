...
const FIELD_GUIDE_LINKS = [
  { label: 'Hızlı Başlangıç', href: `${GUIDE_BASE}#saha-personeli` },
  { label: 'Saha Operasyon Merkezi', href: `${GUIDE_BASE}#saha-personeli` },
  { label: 'Hasar Dosyası Yönetimi', href: `${GUIDE_BASE}#dosya-merkezi` },
  { label: 'Carilerim', href: '/panel/carilerim' },
  { label: 'Hasar Dosyalarım', href: '/panel/hasar-dosyalari' },
...
function GuideFooter() {
  return (
    <a
      href={`${GUIDE_BASE}#saha-personeli`}
      target="_blank"
...
/** Saha: >1440px sağ panel; finans / onay linkleri yok */

...
export function TeamWorkloadChart() {
  ...
  if (isLoading) {
    return (
      <div className="mt-3 h-24 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-800" />
    );
  }

  return (
    <div className="mt-3">
      <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Ekip Yoğunluğu</p>

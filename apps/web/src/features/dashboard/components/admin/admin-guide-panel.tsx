...
const GUIDE_LINKS = [
  ...
  { label: 'Dashboard Kullanımı', href: `${GUIDE_BASE}#operasyon-merkezi` },
  { label: 'Dosya Yönetimi', href: `${GUIDE_BASE}#dosya-merkezi` },
  { label: 'Operasyon Süreçleri', href: `${GUIDE_BASE}#dosya-sorumlusu` },
  { label: 'Finans Yönetimi', href: `${GUIDE_BASE}#finans-modulleri` },
  { label: 'Raporlar', href: '/panel/raporlar' },
  { label: 'Sıkça Sorulan Sorular', href: `${GUIDE_BASE}` },
  { label: 'Video Rehberler', href: `${GUIDE_BASE}` },
] as const;
...
/** >1440px sağ panel; daha dar ekranda altta açılır kapanır */

      ...
      {isLoading || isFetching ? (
        ...
        <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-2">
          <Link
            ...
            className="rounded-lg border border-red-200 bg-red-50 p-4 text-left transition-colors hover:bg-red-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:border-red-900/50 dark:bg-red-950/20 dark:hover:bg-red-950/40"
          >
          ...
          <Link
            ...
            className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-left transition-colors hover:bg-amber-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:border-amber-900/50 dark:bg-amber-950/20 dark:hover:bg-amber-950/40"
          >

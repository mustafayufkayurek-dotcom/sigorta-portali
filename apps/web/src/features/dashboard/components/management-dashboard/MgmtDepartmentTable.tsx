    ...
    >
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-100 px-3 py-2.5">
        ...
        <button
          type="button"
          onClick={onExcel}
          className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-emerald-200 bg-emerald-50 text-emerald-700 transition hover:scale-105 hover:bg-emerald-100"
          title="Detaylı Rapor (Excel)"
          aria-label="Detaylı Rapor (Excel)"
        >

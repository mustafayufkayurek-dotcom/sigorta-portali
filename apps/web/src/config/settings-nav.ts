...
export const SETTINGS_NAV_GROUPS: SettingsNavGroup[] = [
  ...
  },
  {
    ...
    icon: BookOpenText,
    links: [
      { title: 'Tanımlar Merkezi', href: '/panel/ayarlar/tanimlar', icon: BookOpenText, description: 'Departman, ilişki türü, dosya konusu, evrak türü ve diğer tanım aileleri.' },

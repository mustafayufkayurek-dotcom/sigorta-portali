        ...
        <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
          ...
          {addButtonText && onAdd && (
            <button
              type="button"
              onClick={onAdd}
              className="inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 sm:w-auto"
            >

    ...
    >
      {!embedded && (
        <button
          ...
          className={
            compact
              ? 'w-full flex items-center justify-center gap-1.5 rounded-lg py-2 px-3 bg-brand-600 text-white text-xs font-semibold hover:bg-brand-700 transition-colors'
              : 'w-full flex items-center justify-center gap-2 rounded-xl py-3 px-3 bg-brand-600 text-white border-2 border-blue-700 text-sm sm:text-[15px] font-bold shadow-md shadow-blue-200/60 ring-2 ring-blue-100 hover:bg-brand-700 transition-colors'
          }

...
function buildPopupHtml(pin: InsuranceMapPin, interactive: boolean): string {
  ...
  return `
    <div data-popup-pin-id="${pin.id}" style="font-family:system-ui,-apple-system,sans-serif;min-width:240px;max-width:280px;color:#E2E8F0;background:#0B1F3A;border-radius:12px;padding:0;margin:0;">

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-xl max-w-md w-full p-6">
        {step === 1 ? (
          <>
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-2">Arşiv Onayı (1/2)</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300 mb-6">
              <span className="font-semibold font-mono">{fileNo}</span> dosyasını arşive taşımak istediğinize emin misiniz?
              Dosya operasyon listesinden kalkar.
            </p>
          ...
          <>
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-2">Arşiv Onayı (2/2)</h3>

        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <div>
            ...
            <button
              ...
              disabled={uploading}
              className="inline-flex items-center gap-2 bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-700 active:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
            >
              <UploadIcon />
                ...
                <div className="flex items-center justify-center h-full py-16">
                  <div className="text-center">
                    ...
                    <button
                      type="button"
                      onClick={() => handleDownload(previewDoc.id, previewDoc.fileName)}
                      className="inline-flex items-center gap-2 bg-brand-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-brand-700 transition-colors shadow-sm"
                    >
                      <DownloadIcon />
                      Dosyayı İndir
                    </button>

...
**Son bilinen iyi sürüm:** Web **v350** + Backend **v349** (`deploy/manifests/KNOWN_GOOD_IMAGES.json`)  
**Etiket:** `v350-logo-sidebar-topbar` (web) + `v349-guvenlik-finans-api-guard` (backend)  
**Güncelleme:** 14 Temmuz 2026

**Rollback tag'leri:** Web **v348** + Backend **v348** (manifest `rollbackImages`)

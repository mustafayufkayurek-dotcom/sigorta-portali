...
**Son bilinen iyi sürüm:** Web **v354** + Backend **v349** (`deploy/manifests/KNOWN_GOOD_IMAGES.json`)  
**Etiket:** `v354-enterprise-v3-nihai-duzeltme` (web) + `v349-guvenlik-finans-api-guard` (backend)  
**Güncelleme:** 14 Temmuz 2026

**Rollback tag'leri:** Web **v353** + Backend **v349** (manifest `rollbackImages`)
